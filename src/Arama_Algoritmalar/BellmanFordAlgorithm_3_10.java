...
class BellmanFordAlgorithm_3_10 {
    ...
    BellmanFordAlgorithm_3_10(int v, int e) {
        V = v;
        E = e;
    ...
    void BellmanFord(BellmanFordAlgorithm_3_10 graph, int s) {
    ...
    public static void main() {
        ...
        BellmanFordAlgorithm_3_10 graph = new BellmanFordAlgorithm_3_10(V, E);
